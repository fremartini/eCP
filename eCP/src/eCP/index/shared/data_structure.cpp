 ...
 * Point data type
 */
Point::Point(const float* descriptor_, unsigned id_) : descriptor(new float[globals::g_vector_dimensions]), id(id_) {
 ...
 * Index data type
 */
Index::Index(unsigned L_, std::vector<Node>& top_level_, std::vector<Point>& dataset_) : L(L_), top_level(top_level_), dataset(dataset_) {}
